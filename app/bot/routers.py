...
from app.bot.handlers import fallback, level, menu, payments, profile, review, start, subscription, theme, training
...
def build_root_router() -> Router:
    ...
    router.include_router(_clone_router(review.router))
